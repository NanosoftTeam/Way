<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('surname') }}
            {{ Form::text('surname', $contact->surname, ['class' => 'form-control' . ($errors->has('surname') ? ' is-invalid' : ''), 'placeholder' => 'Surname']) }}
        ...
        <div class="form-group">
            {{ Form::label('account') }}
            {{ Form::text('account', $contact->account, ['class' => 'form-control' . ($errors->has('account') ? ' is-invalid' : ''), 'placeholder' => 'Account']) }}
            {!! $errors->first('account', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
