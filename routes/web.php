...
Route::namespace('api')->group(function () {
    Route::post('/api/login', [UserController::class, 'apiPostLogin']);
});
...
Route::middleware(['auth'])->group(function(){
    ...
    Route::middleware(['can:isIT'])->group(function(){
        ...
        Route::get('/notes/wiki', [\App\Http\Controllers\NoteController::class, 'wiki'])->name('notes.wiki');
        ...
        Route::get('/my-teams', [\App\Http\Controllers\TeamController::class, 'index2'])->name('team.index2');
        Route::get('/team/enter', [\App\Http\Controllers\TeamController::class, 'team_enter'])->name('team.enter');
