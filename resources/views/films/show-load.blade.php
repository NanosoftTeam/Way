...
<div class="container">
  <div class="row">
    <div class="col-sm" style="margin-bottom: 8px;">
        <div class="card">
            <div class="card-header"><a href="{{ route('films.index') }}">Filmy</a> > <a href="{{ route('courses.show', $film->course->id) }}">{{ $film->course->name }}</a> > {{ $film->title }} 
    ...
    <div class="col-sm">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-tasks-tab" data-toggle="tab" href="#nav-tasks" role="tab" aria-controls="nav-tasks" aria-selected="false"><i class="fa-solid fa-list-check"></i> Zadania</a>
        ...
        <a href="{{ route('films.plan.calendar', $film->id) }}" style="margin-right: 15px;" class="float-right"><i class="fa-solid fa-calendar"></i> Kalendarz</a>
            ...
            <div class="tab-pane fade" id="nav-yt" role="tabpanel" aria-labelledby="nav-yt-tab">
                ...
                @else
                    <br />
                    <div class="alert alert-primary" role="alert">Brak linku!</div>
                @endif     
            </div>
