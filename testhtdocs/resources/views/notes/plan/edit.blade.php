...
<div class="container">
        <div class="row border-bottom">
            <h4>Edycja podnotatek (tylko głównych)</h4>
            ...
            <ul></ul>
                ...
                <table class="table table-sm table-bordered table-hover" id="dynamic_field"> 
                    <tr>
                        ...
                        <td><button type="button" name="add" id="add" class="btn btn-sm btn-success">Dodaj</button></td>  
                    </tr>  
                </table>
                ...
                <table class="table table-sm table-bordered table-hover" id="dynamic_field">
                    @foreach($tasks as $task)
                        <tr class="dynamic-added">
                            ...
                            <td><label class="text-danger"><input type="checkbox" name="tasks[{{ $task->id }}][delete]"> Usuń</label></td>
                        </tr>
                    @endforeach
                </table>
